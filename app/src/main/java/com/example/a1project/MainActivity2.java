...
public class MainActivity2 extends AppCompatActivity {
    ...
    private TextInputEditText nameEditText, passwordEditText, houseNameEditText, numberEditText, emailEditText, addressEditText;
                                ...
                                if (user != null) {
                                    ...
                                    databaseReference.setValue(userValues)
                                            .addOnSuccessListener(unused -> {
                                                Toast.makeText(MainActivity2.this, "Success! You've created your account.", Toast.LENGTH_SHORT).show();
